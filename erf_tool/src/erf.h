...
enum erf_resource_type {
    ...
    ERF_RESOURCE_TYPE_MPG = 0x0009,
    ERF_RESOURCE_TYPE_TXT = 0x000a,
    ERF_RESOURCE_TYPE_PLH = 0x07d0,
    ERF_RESOURCE_TYPE_TEX = 0x07d1,
    ERF_RESOURCE_TYPE_MDL = 0x07d2,
    ERF_RESOURCE_TYPE_THG = 0x07d3,
    ERF_RESOURCE_TYPE_FNT = 0x07d5,
    ERF_RESOURCE_TYPE_LUA = 0x07d7,
    ERF_RESOURCE_TYPE_SLT = 0x07d8,
    ...
    ERF_RESOURCE_TYPE_TTF = 0x081a,
    ERF_RESOURCE_TYPE_SQL = 0x081b,
    ERF_RESOURCE_TYPE_TML = 0x081c,
    ERF_RESOURCE_TYPE_SQ3 = 0x081d,
    ERF_RESOURCE_TYPE_LOD = 0x081e,
    ERF_RESOURCE_TYPE_GIF = 0x081f,
    ERF_RESOURCE_TYPE_PNG = 0x0820,
    ERF_RESOURCE_TYPE_JPG = 0x0821,
    ERF_RESOURCE_TYPE_CAF = 0x0822,
    ERF_RESOURCE_TYPE_JUI = 0x0823,
