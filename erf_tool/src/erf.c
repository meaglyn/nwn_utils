...
static const char *get_extension_from_type(u32 type)
{
    ...
    case ERF_RESOURCE_TYPE_MVE: return ".mve";
    ...
    case ERF_RESOURCE_TYPE_MPG: return ".mpg";
    case ERF_RESOURCE_TYPE_TXT: return ".txt";
    case ERF_RESOURCE_TYPE_PLH: return ".plh";
    case ERF_RESOURCE_TYPE_TEX: return ".tex";
    case ERF_RESOURCE_TYPE_MDL: return ".mdl";
    case ERF_RESOURCE_TYPE_THG: return ".thg";
    case ERF_RESOURCE_TYPE_FNT: return ".fnt";
    case ERF_RESOURCE_TYPE_LUA: return ".lua";
    case ERF_RESOURCE_TYPE_SLT: return ".slt";
    ...
    case ERF_RESOURCE_TYPE_BTE: return ".bte";
    case ERF_RESOURCE_TYPE_UTE: return ".ute";
    case ERF_RESOURCE_TYPE_BTD: return ".btd";
    case ERF_RESOURCE_TYPE_UTD: return ".utd";
    case ERF_RESOURCE_TYPE_BTP: return ".btp";
    ...
    case ERF_RESOURCE_TYPE_LOD: return ".lod";
    case ERF_RESOURCE_TYPE_GIF: return ".gif";
    case ERF_RESOURCE_TYPE_PNG: return ".png";
    case ERF_RESOURCE_TYPE_JPG: return ".jpg";
    case ERF_RESOURCE_TYPE_CAF: return ".caf";
    case ERF_RESOURCE_TYPE_JUI: return ".jui";
...
static u32 get_type_from_extension(const char *ext)
{
    ...
    if (strncmp(ext, "mve", 3) == 0) return ERF_RESOURCE_TYPE_MVE;
    ...
    if (strncmp(ext, "mpg", 3) == 0) return ERF_RESOURCE_TYPE_MPG;
    if (strncmp(ext, "txt", 3) == 0) return ERF_RESOURCE_TYPE_TXT;
    if (strncmp(ext, "plh", 3) == 0) return ERF_RESOURCE_TYPE_PLH;
    if (strncmp(ext, "tex", 3) == 0) return ERF_RESOURCE_TYPE_TEX;
    if (strncmp(ext, "mdl", 3) == 0) return ERF_RESOURCE_TYPE_MDL;
    if (strncmp(ext, "thg", 3) == 0) return ERF_RESOURCE_TYPE_THG;
    if (strncmp(ext, "fnt", 3) == 0) return ERF_RESOURCE_TYPE_FNT;
    if (strncmp(ext, "lua", 3) == 0) return ERF_RESOURCE_TYPE_LUA;
    if (strncmp(ext, "slt", 3) == 0) return ERF_RESOURCE_TYPE_SLT;
    ...
    if (strncmp(ext, "tlk", 3) == 0) return ERF_RESOURCE_TYPE_TLK;
    if (strncmp(ext, "txi", 3) == 0) return ERF_RESOURCE_TYPE_TXI;
    if (strncmp(ext, "git", 3) == 0) return ERF_RESOURCE_TYPE_GIT;
    if (strncmp(ext, "bti", 3) == 0) return ERF_RESOURCE_TYPE_BTI;
    if (strncmp(ext, "uti", 3) == 0) return ERF_RESOURCE_TYPE_UTI;
    if (strncmp(ext, "btc", 3) == 0) return ERF_RESOURCE_TYPE_BTC;
    ...
    if (strncmp(ext, "btt", 3) == 0) return ERF_RESOURCE_TYPE_BTT;
    if (strncmp(ext, "utt", 3) == 0) return ERF_RESOURCE_TYPE_UTT;
    if (strncmp(ext, "dds", 3) == 0) return ERF_RESOURCE_TYPE_DDS;
    if (strncmp(ext, "bts", 3) == 0) return ERF_RESOURCE_TYPE_BTS;
    ...
    if (strncmp(ext, "bte", 3) == 0) return ERF_RESOURCE_TYPE_BTE;
    if (strncmp(ext, "ute", 3) == 0) return ERF_RESOURCE_TYPE_UTE;
    if (strncmp(ext, "btd", 3) == 0) return ERF_RESOURCE_TYPE_BTD;
    if (strncmp(ext, "utd", 3) == 0) return ERF_RESOURCE_TYPE_UTD;
    if (strncmp(ext, "btp", 3) == 0) return ERF_RESOURCE_TYPE_BTP;
    ...
    if (strncmp(ext, "css", 3) == 0) return ERF_RESOURCE_TYPE_CSS;
    if (strncmp(ext, "ccs", 3) == 0) return ERF_RESOURCE_TYPE_CCS;
    if (strncmp(ext, "btm", 3) == 0) return ERF_RESOURCE_TYPE_BTM;
    ...
    if (strncmp(ext, "btg", 3) == 0) return ERF_RESOURCE_TYPE_BTG;
    if (strncmp(ext, "utg", 3) == 0) return ERF_RESOURCE_TYPE_UTG;
    ...
    if (strncmp(ext, "4pc", 3) == 0) return ERF_RESOURCE_TYPE_4PC;
    ...
    if (strncmp(ext, "bik", 3) == 0) return ERF_RESOURCE_TYPE_BIK;
    if (strncmp(ext, "ndb", 3) == 0) return ERF_RESOURCE_TYPE_NDB;
    ...
    if (strncmp(ext, "lod", 3) == 0) return ERF_RESOURCE_TYPE_LOD;
    if (strncmp(ext, "gif", 3) == 0) return ERF_RESOURCE_TYPE_GIF;
    if (strncmp(ext, "png", 3) == 0) return ERF_RESOURCE_TYPE_PNG;
    if (strncmp(ext, "jpg", 3) == 0) return ERF_RESOURCE_TYPE_JPG;
    if (strncmp(ext, "caf", 3) == 0) return ERF_RESOURCE_TYPE_CAF;
    if (strncmp(ext, "jui", 3) == 0) return ERF_RESOURCE_TYPE_JUI;
